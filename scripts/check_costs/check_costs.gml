...
if Upgrade = 1 {
    ...
    repeat global.AmountOfBuildingUpgrades {
        if ds_map_find_value(global.BuildingUpgrades[_Rounds],"Name") == UpgradeType {
            UpgradeType = ""
    ...
    buffer_write(Buffer, buffer_u32, XUpgradeLocation)
    buffer_write(Buffer, buffer_u32, YUpgradeLocation)
    buffer_write(Buffer, buffer_u32, UpgradeLayer)
